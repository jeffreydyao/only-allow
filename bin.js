...
For more details, go to https://yarnpkg.com/`, boxenOpts))
      break
      case 'bun':
        console.log(boxen(`Use "bun add" for installation in this project.
  
  If you don't have Bun, install it via "curl https://bun.sh/install | bash".
  For more details, go to https://bun.sh`, boxenOpts))
        break
  }
  process.exit(1)
}
